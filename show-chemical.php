...
<form style="text-align: center;" id="form_file"  action="decode-chemical.php" method="post" enctype="multipart/form-data">
    ...
    <input id="file" name="file" type="file" title="Scan again" accept="image/*" />
</form>
</div>
<script type="text/javascript">
    $(document).ready( function() {
...
<?php
    ...
    ?>
        <div style="font-size: 20px;">
            ...
            <b>Expiry Date</b> <?= $chemical['expire_date'] ?> <br/>
        </div>
    <form id="lendForm" action="lend-chemical.php" method="post">
        <h3>Order</h3>
            ...
            <br/>
            <a class="btn btn-lg btn-primary btnScan" type="submit">Scan again</a>
            <a class="btn btn-lg btn-info btnDone" style="margin-left: 50px;">Finish</a>
    </form>
<div>
    <script type="text/javascript">
        $(document).ready(function(){
