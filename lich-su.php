...
<div id="history" class="span8">
    ...
    ?>
    <h3>History: <?= $user['full_name'] ?></h3>
    <div id="nav" class="row-fluid">
        <ul>
            <li class="active"><a class="btn btn-lg" data-toggle="tab" href="#chemical">Personal</a></li>
            <li><a class="btn btn-lg" data-toggle="tab" href="#equipment">Food & Beverage</a></li>
        <li><a class="btn btn-lg" data-toggle="tab" href="#library">Households</a></li>
        </ul>
    </div>
...
<div id="info" class="span4">
    ...
    $user = mysql_fetch_array($rUser);
    ?>
    <h3>Producer: <?= $user['full_name'] ?></h3>
    <h4>Distributor:</h4> <?= $user['position'] ?><br/>
    <h4>Address:</h4> <?= $user['department'] ?><br/>
</div>
