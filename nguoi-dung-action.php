...
<div class="span5 offset2">
    <form method="post">
        ...
        <div class="form-group">
            <label for="position">Distributor:</label>
...
<div class="span5 offset2">
    <form method="post">
        <div class="form-group">
            <label for="code">ID:</label>
            <input type="text" class="form-control" id="code" name="code" placeholder="Ex:U001...">
        </div>
        <div class="form-group">
            <label for="name">Name:</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="Coca-Cola">
        </div>
        <div class="form-group">
            <label for="position">Distributor:</label>
            <input type="text" class="form-control" id="position" name="position" placeholder="7eleven">
        </div>
        <div class="form-group">
            <label for="department">Address:</label>
            <input type="text" class="form-control" id="department" name="department" placeholder="52 Nanyang Walk, Singapore 639928">
        </div>
